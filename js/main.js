...
document.addEventListener('DOMContentLoaded', async () => {
    ...
    if (!playButton || !buttonText || !spinner || !overlay) {
        console.error("Critical UI elements are missing. Player cannot start.");
        return;
    }
    ...
    try {
        ...
        // Use lightInit to prepare player without starting audio
        await player.lightInit();
        ...
        playButton.disabled = false;
        spinner.style.display = 'none';
        buttonText.textContent = 'Ошибка. Перезагрузите';
